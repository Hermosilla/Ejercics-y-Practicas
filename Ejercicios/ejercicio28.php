...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"> Tu direcciòn de e-mail: <br>
<input type="text" name="Mail" ><br> Tu comentario: <br>
...
<?php
$receiverMail = "tudireccion@tudominio.es"; // escribe aqui tu direcciòn if (isset($_POST['Mail']) && $_POST['Mail'] != "") {
